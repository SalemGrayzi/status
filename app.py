...
dfds1 = df.groupby(['Time to Deploy in Min']).size().to_frame().sort_values([0], ascending = False).reset_index() ### Grouping them then using the filter to specify how many it should show
